                            ...
                            .map((activity) => (
                                <div key={activity._id} className={styles.eventSection}>
                                    <div className={styles.eventBox}>
                                        <p className={styles.eventBox1}>{getDayOfWeek(new Date(activity.date))}</p>
                                        <p className={styles.eventBox2}>{getTime(new Date(activity.date))}</p>
                                        <p className={styles.eventBox3}>
                                            {new Date(activity.date).toLocaleDateString()}
                                        </p>
                                    </div>
                                    <div>
                                        <h3 className={styles.eventSchedule}>일정: {activity.title}</h3>
                                        <p className={styles.eventDesc}>내용: {activity.description}</p>
